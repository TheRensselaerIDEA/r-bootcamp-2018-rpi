---
title: "R Bootcamp, Module 8: </br>Graphics"
date: "January 2018 (RPI)"
author:
- "Created by: Kellie Ottoboni and Chris Krogslund (UC Berkeley)"
...
* Three main facilities for producing graphics in R: 
    * **base**
    * **lattice**
    * **ggplot2**
...
* A better formulation: 
    * **quick & dirty** 
    * **involved, subtle, fancy, expressive...** 
...
For a nice explanation (using R!) of regression diagnostics see e.g. [Regression diagnostic plots (CMU)](https://www.andrew.cmu.edu/user/achoulde/94842/homework/regression_diagnostics.html)
