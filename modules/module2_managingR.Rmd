...
# platform-agnostic
setwd(file.path('~', 'Desktop', 'r-bootcamp-2017', 'modules')) # change the working directory
setwd(file.path('/', 'Users', 'paciorek', 'Desktop', 'r-bootcamp-2017', 'modules')) # absolute path
getwd()
